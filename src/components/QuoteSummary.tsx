  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
      ...
      <p className="text-[10px] text-zinc-600 mt-3">
        Customer supplies controller. Calibration included with TMR installs. ExtremeRate parts at retail USD ×1.76 NZD. $15 parts &amp; tools fee covers consumables. DualSense Edge service surcharge ($27.50) applies to all Edge jobs. Trade-in discount ($40 NZD/controller average) applies to controllers other than the one being modded — final amount confirmed once controllers are checked for version, wear, and damage.
      </p>
    </div>
  );
}
